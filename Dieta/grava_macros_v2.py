...
def valida_data(sheet, celula):
    ...
    while True:
        ...
        try:
            ...
            if k.value.day == datetime.today().day:
                return True
            return False


def salva_tudo(quantidade, macros, refeicao):
    '''
        ...
        for i in j: # Itera por todas células de uma determinada  coluna
            ...
            if i.value == refeicao: # Verifica se o nome da refeição passada
                ...
                while index < 6: # Itera pela seis células adjacentes
                    ...
                    if sheet_calorias[n_cel].value is None and valida_data(sheet_calorias,n_cel):
